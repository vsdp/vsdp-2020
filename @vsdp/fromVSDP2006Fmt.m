function obj = fromVSDP2006Fmt (blk, A, C, b, X0, y0, Z0)
% FROMVSDP2006FMT  Import SDP problem data from VSDP 2006 format.
%
...
if (~iscell (blk) || isempty (blk{1,2}))
  error ('VSDP:FROMVSDP2006FMT', ...
    '@vsdp/fromVSDP2006Fmt: bad cone structure `blk`');
else
  K.s = cat (1, blk{:,2});
end
